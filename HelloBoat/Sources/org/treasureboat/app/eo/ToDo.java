...
*/
{
  ...
  public static final ToDoClazz<ToDo> clazz = new ToDoClazz<ToDo>();
  public static class ToDoClazz<T extends ToDo> extends _ToDo._ToDoClazz<T>
  /*
  implements 
