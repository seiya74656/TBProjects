...
public abstract class _ToDo extends  TBEOGenericRecord  {
  ...
  protected static String BUTTON_INSPECT = "ToDo.hide.inspect";
  protected static String BUTTON_EDIT = "ToDo.hide.edit";
  protected static String BUTTON_DELETE = "ToDo.hide.delete";
  protected static String BUTTON_REMOVE = "ToDo.hide.remove";
