...
public class Gewinnspiel extends TBComponent {
  ...
  public NSArray<GewinnspielTeilnehmer> allGewinnspielTeilnehmers() {
    return GewinnspielTeilnehmer.fetchAllGewinnspielTeilnehmers(editingContext());
  }

  public GewinnspielTeilnehmer oneGewinnspiel;

  public WOActionResults doCreateAction() {

    EOEditingContext ec = ERXEC.newEditingContext();

    GewinnspielTeilnehmer newGewinnspielTeilnehmer = GewinnspielTeilnehmer.createAndInsertInstance(ec);
    newGewinnspielTeilnehmer.setAntwort(1);
    newGewinnspielTeilnehmer.setName("Rene");
    newGewinnspielTeilnehmer.setAgb(agb);
    newGewinnspielTeilnehmer.setEmail("seiya@me.com");
    newGewinnspielTeilnehmer.setDatum(new NSTimestamp());
    log.info("here------>>>");
    ec.saveChanges();
